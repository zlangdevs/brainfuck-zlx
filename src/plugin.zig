...
const FileExtensionRequest = sdk.FileExtensionRequest;
const FileExtensionResult = sdk.FileExtensionResult;
const FileExtensionHandler = sdk.FileExtensionHandler;
